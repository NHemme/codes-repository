...
def MakePlotOverlay(infile1 = '', infile2 = '', id1 = '', id2 = '', histnumber = int, groomed_plots = False, var_legend = True):
    rootfile1 = infile1
    rootfile2 = infile2
    ...
    norm1 = h1.GetEntries()
    scale1 = 1/h1.Integral();
    h1.Scale(scale1);
    norm2 = h2.GetEntries()
    scale2 = 1/h2.Integral();
    h2.Scale(scale2);
...
if histnumber >= 0 and histnumber <= 28:
    MakePlotOverlay(infile1, infile2, id1, id2, histnumber, groomed_plots = False, scale_au = True, var_legend = True)
else:
    for hist in range(0,29):
        ...
        #else:
        print(hist)
        MakePlotOverlay(infile1, infile2, id1, id2, histnumber = hist, groomed_plots = False, var_legend = False)
